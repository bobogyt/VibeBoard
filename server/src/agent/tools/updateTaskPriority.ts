...
export const updateTaskPriorityTool: Tool = {
  ...
  validate(args) {
    ...
    if (!PRIORITIES.includes(args.priority as string)) return 'priority 需为 P0/P1/P2/P3'
    return null
  },
  async execute(args, ctx) {
    return { task: await updateTaskPriority(ctx.userId as string, args.taskId, args.priority) }
  },
}
